...
- **Time Machine** runs continuosly and stores last 30 seconds of final output. Tapping it keeps the history and appends to it the current output, press either **Time Machine** or **Record** again to finish and save
